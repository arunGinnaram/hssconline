...
public class JspsApplication1 {
	...
	public String sendSingleSMS(String username, String password , String message , String senderId, String mobileNumber,String secureKey){
		...
		try {
			...
			HttpPost post=new
					HttpPost("https://msdgweb.mgov.gov.in/esms/sendsmsrequest");
	...
	public String sendOtpSMS(String username, String password , String message , String senderId, String mobileNumber,String secureKey,String templateId){
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("mobileno", 	mobileNumber.trim()));
			nameValuePairs.add(new BasicNameValuePair("senderid", senderId.trim()));
			nameValuePairs.add(new BasicNameValuePair("content", message.trim()));
			...
			nameValuePairs.add(new BasicNameValuePair("password", encryptedPassword.trim()));
			nameValuePairs.add(new BasicNameValuePair("key", genratedhashKey.trim()));
			nameValuePairs.add(new BasicNameValuePair("templateid", templateId.trim()));
